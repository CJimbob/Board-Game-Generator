...
const ERROR_EN: Record<string, string> = {
  ...
  "盗贼不能偷窃自己。": "The Thief cannot rob themself.",
  "勒索者必须选择两个不同的目标角色。": "The Blackmailer must choose two different target characters.",
  "勒索者不能威胁自己。": "The Blackmailer cannot threaten themself.",
  "不能威胁被刺杀或被魅惑的角色。": "You cannot threaten an assassinated or bewitched character.",
  "请在两个目标中指定真威胁。": "Choose which of the two targets receives the real threat.",
